...
with st.sidebar:
    st.title("PregnaSafe")
    st.write("Welcome to the PregnaSafe")
...
if (selected == 'About us'):
    ...
    st.title("Welcome to PregnaSafe")
    st.write("At PregnaSafe, our mission is to revolutionize healthcare by offering innovative solutions through predictive analysis. "
...
if (selected == 'Pregnancy Risk Prediction'):
    ...
    with col2:
        SystolicBP = st.text_input('SystolicBP in mmHg')
